        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative hidden md:block">
            ...
            <Input
              ...
              className="w-80 pl-10 bg-muted/30 border-border/50 focus:border-primary/50"
            />
          </div>
        </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="rounded-full">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-sm font-medium text-primary-foreground">
                  {userInitials}
                </div>
              </Button>
            </DropdownMenuTrigger>
